...
CREATE TYPE "public"."module_type" AS ENUM('user', 'project', 'finance', 'product', 'client', 'reporting', 'admin');--> statement-breakpoint
...
ALTER TABLE "activities_feed" ADD CONSTRAINT "activities_feed_milestone_id_milestones_id_fk" FOREIGN KEY ("milestone_id") REFERENCES "public"."milestones"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "employee_skills" ADD CONSTRAINT "employee_skills_employee_id_employees_id_fk" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
ALTER TABLE "employee_skills" ADD CONSTRAINT "employee_skills_skill_id_skills_id_fk" FOREIGN KEY ("skill_id") REFERENCES "public"."skills"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
...
ALTER TABLE "kanban_board_order" ADD CONSTRAINT "kanban_board_order_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "milestone_project_id_idx" ON "milestones" USING btree ("project_id");--> statement-breakpoint
...
CREATE INDEX "task_project_id_idx" ON "tasks" USING btree ("project_id");